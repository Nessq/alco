!(function (t, e) {
  ...
  function o(t, e) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (i = 0; i < s.length; i++)
        (n = s[i]),
          e.indexOf(n) >= 0 ||
            (Object.prototype.propertyIsEnumerable.call(t, n) && (u[n] = t[n]));
    }
    return u;
  }
  function l(t, e) {
        ...
        "undefined" != typeof Reflect && Reflect.get
          ...
          : function (t, e, n) {
              ...
              if (i) {
                ...
                return u.get
                  ? u.get.call(arguments.length < 3 ? t : n)
                  : u.value;
              }
            }),
  ...
  function D(t, n) {
    ...
    return (
      !(!n || !t || "function" != typeof n || "function" != typeof t) &&
    ...
    return (
      u(t, [
        ...
        },
        {
          ...
          value: function (t) {
            return t
              ? ((this._value += t), new y({ inserted: t, rawInserted: t }))
              : new y();
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t, e, n, i) {
            ...
            this.eager &&
              ((i = F(i)), (u = this.extractInput(0, r, { raw: !0 })));
            var o = this.nearestInputPos(
                t,
                e > 1 && 0 !== t && !this.eager ? _ : i
              ),
            ...
            if (this.eager && i !== _ && u === this.rawInputValue)
              if (i === b)
                for (
                  var h;
                  u === this.rawInputValue && (h = this.value.length);

                )
                  l.aggregate(new y({ tailShift: -1 })).aggregate(
                    this.remove(h - 1)
                  );
              else i === E && a.unshift();
      ...
      return (
        u(t, [
          ...
          },
          {
            key: "appendTo",
            value: function (e) {
              if (!(e instanceof M.MaskedPattern))
                return new w(this.toString()).appendTo(e);
              for (
                var n = new y(), i = 0;
                  ...
                  n.pushRightBeforeFilled()
                    ...
                    : (n.popState(),
                      n.ok
                        ? n.pos
                        : (n.popState(),
                          n.ok ? n.pos : this.nearestInputPos(t, A))))
                : t;
            },
          },
          {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            null != t.maxLength && (e = Math.max(e, t.maxLength)),
              (t.maxLength = e);
            for (
              var n = String(t.from).padStart(e, "0"),
            ...
            var e,
              n =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {},
              u = B(
                f(r(i.prototype), "doPrepare", this).call(
                  this,
                  t.replace(/\D/g, ""),
                  n
                )
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              this.from <= Number(o) &&
              Number(a) <= this.to &&
              (t = f(r(i.prototype), "doValidate", this)).call.apply(
                t,
                [this].concat(h)
              )
            );
    ...
    return (
      u(i, [
        ...
        },
        {
          ...
          get: function () {
            return this.isComplete
              ? f(r(i.prototype), "typedValue", this)
              : null;
          },
          set: function (t) {
        ...
        },
        {
          ...
          value: function (t) {
            return (
              t === Date || f(r(i.prototype), "maskEquals", this).call(this, t)
            );
          },
        },
      ]),
    ...
    return (
      u(i, [
        ...
        },
        {
          ...
          value: function () {
            for (
              var t, e = this, n = arguments.length, u = new Array(n), s = 0;
              s < n;
              s++
            )
              u[s] = arguments[s];
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                ...
                s[a - 1] = arguments[a];
              var o = B(
                  (e = f(r(i.prototype), "doPrepare", this)).call.apply(
                    e,
                    [this, n].concat(s)
                  )
                ),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!this.thousandsSeparator)
                return f(r(i.prototype), "_appendCharRaw", this).call(
                  this,
                  t,
                  e
                );
              ...
              var s = f(r(i.prototype), "_appendCharRaw", this).call(
                this,
                t,
                e
              );
          ...
          },
          {
            ...
            value: function () {
              ...
              this._value = this._insertThousandsSeparators(
                this._removeThousandsSeparators(u + s)
              );
  ...
  var nt = ["compiledMasks", "currentMaskRef", "currentMask"],
    it = (function (t) {
      ...
      function i(t) {
        ...
        return (
          n(this, i),
          ((u = e.call(this, Object.assign({}, i.DEFAULTS, t))).currentMask =
            null),
          u
        );
      }
      return (
        u(i, [
          ...
          },
          {
            ...
            set: function (t) {
              ...
              this.compiledMasks.forEach(function (t, n) {
                ...
                null != n &&
                  ((this.currentMask = n), (this.currentMask.state = u)),
          ...
          },
          {
            ...
            value: function () {
              for (
                var t, e, n = arguments.length, u = new Array(n), s = 0;
                s < n;
                s++
              )
                u[s] = arguments[s];
              return this.currentMask
                ...
                : (e = f(r(i.prototype), "extractTail", this)).call.apply(
                    e,
                    [this].concat(u)
                  );
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              return this.currentMask
                ...
                : (e = f(r(i.prototype), "nearestInputPos", this)).call.apply(
                    e,
                    [this].concat(u)
                  );
            },
